...
```bash
git clone www.github.com/mahmud-arif/nextjs-express-redis-microservice
cd nextjs-express-redis-microservice

Create `.env` file in the root directory, copy and paste value from env.example and replace it with your value
